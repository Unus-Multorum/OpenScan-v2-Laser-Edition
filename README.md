The target is to design a laser cut version of the OpenScan v2 as compatible as possible with 3D printed parts. Current effort is on the rotor arm which is the hardest to print in a single piece.
